...
import { 
    Loader2, Shield, Eye, EyeOff, Trash2, AlertTriangle, Globe 
} from "lucide-react"
...
export function SettingsForm({ user, isGoogleUser }: SettingsFormProps) {
								...
								<div className="flex items-start gap-3">
									...
									<div className="space-y-2">
										...
										<p className="text-sm text-blue-700 dark:text-blue-300">
											You're signed in with Google. To manage your password and security settings, please visit your Google Account settings.
										</p>
										<a
											href="https://myaccount.google.com/security"
											target="_blank"
											rel="noopener noreferrer"
											className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline mt-2"
										>
